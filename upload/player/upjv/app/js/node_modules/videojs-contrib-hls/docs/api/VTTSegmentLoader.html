...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: VTTSegmentLoader</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: VTTSegmentLoader</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>VTTSegmentLoader<span class="signature">(options)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="VTTSegmentLoader"><span class="type-signature"></span>new VTTSegmentLoader<span class="signature">(options)</span><span class="type-signature"></span></h4>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">required and optional options</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="vtt-segment-loader.js.html">vtt-segment-loader.js</a>, <a href="vtt-segment-loader.js.html#line18">line 18</a>
    </li></ul></dd>
