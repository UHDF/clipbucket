...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: Representation</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: Representation</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>Representation<span class="signature">()</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="Representation"><span class="type-signature"></span>new Representation<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="rendition-mixin.js.html">rendition-mixin.js</a>, <a href="rendition-mixin.js.html#line42">line 42</a>
    </li></ul></dd>
