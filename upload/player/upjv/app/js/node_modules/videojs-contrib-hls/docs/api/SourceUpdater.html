...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: SourceUpdater</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: SourceUpdater</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>SourceUpdater<span class="signature">(mediaSource, mimeType)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="SourceUpdater"><span class="type-signature"></span>new SourceUpdater<span class="signature">(mediaSource, mimeType)</span><span class="type-signature"></span></h4>
...
<span class="param-type">MediaSource</span>
            ...
            <td class="description last">the MediaSource to create the
SourceBuffer from</td>
        </tr>
...
<span class="param-type">String</span>
            ...
            <td class="description last">the desired MIME type of the underlying
SourceBuffer</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="source-updater.js.html">source-updater.js</a>, <a href="source-updater.js.html#line8">line 8</a>
    </li></ul></dd>
