...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: rendition-mixin.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: rendition-mixin.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import { isBlacklisted, isEnabled } from './playlist.js';
/**
