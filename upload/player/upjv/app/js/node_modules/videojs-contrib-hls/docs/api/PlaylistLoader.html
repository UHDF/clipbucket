...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: PlaylistLoader</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: PlaylistLoader</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>PlaylistLoader<span class="signature">(srcUrl, withCredentials)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">PlaylistLoader</div>
...
<article>
    ...
    <h4 class="name" id="PlaylistLoader"><span class="type-signature"></span>new PlaylistLoader<span class="signature">(srcUrl, withCredentials)</span><span class="type-signature"></span></h4>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>srcUrl</code></td>
...
<span class="param-type">String</span>
            ...
            <td class="description last">the url to start with</td>
        </tr>
...
<span class="param-type">Boolean</span>
            ...
            <td class="description last">the withCredentials xhr option</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="playlist-loader.js.html">playlist-loader.js</a>, <a href="playlist-loader.js.html#line119">line 119</a>
    </li></ul></dd>
