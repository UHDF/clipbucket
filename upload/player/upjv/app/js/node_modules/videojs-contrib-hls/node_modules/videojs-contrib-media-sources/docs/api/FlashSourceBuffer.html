...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: FlashSourceBuffer</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: FlashSourceBuffer</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>FlashSourceBuffer<span class="signature">(mediaSource)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="FlashSourceBuffer"><span class="type-signature"></span>new FlashSourceBuffer<span class="signature">(mediaSource)</span><span class="type-signature"></span></h4>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">the flash media source</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="flash-source-buffer.js.html">flash-source-buffer.js</a>, <a href="flash-source-buffer.js.html#line57">line 57</a>
    </li></ul></dd>
