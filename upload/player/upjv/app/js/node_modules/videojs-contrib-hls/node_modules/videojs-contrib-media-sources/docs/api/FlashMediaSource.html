...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: FlashMediaSource</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: FlashMediaSource</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>FlashMediaSource<span class="signature">()</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="FlashMediaSource"><span class="type-signature"></span>new FlashMediaSource<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="flash-media-source.js.html">flash-media-source.js</a>, <a href="flash-media-source.js.html#line11">line 11</a>
    </li></ul></dd>
